...
if [ -n "$1" ]; then
    ...
    case "$1" in
        ...
        cl_ramp_to_3000_FQS3) run_test cl_ramp_to_3000_FQS3 $IARG -DTEST_CL_RAMP_TO_3000 -DRPMRAMP -DCL_MODE -DAFM_CL_RAMP -DRPMEND=3000 "-D_FUEL_QUAL=8'h75" -DSKIP_LAMBDA_WARMUP -DSIM_TIME=40000000000 ;;
        cl_ramp_to_3000_FQS4) run_test cl_ramp_to_3000_FQS4 $IARG -DTEST_CL_RAMP_TO_3000 -DRPMRAMP -DCL_MODE -DAFM_CL_RAMP -DRPMEND=3000 "-D_FUEL_QUAL=8'h81" -DSKIP_LAMBDA_WARMUP -DSIM_TIME=40000000000 ;;
