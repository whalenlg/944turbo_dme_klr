...
if [ -n "$1" ]; then
    ...
    case "$1" in
        ...
        cl_ramp_to_2000_BOOST_HIGH) run_test cl_ramp_to_2000_BOOST_HIGH $IARG -DTEST_CL_RAMP_TO_2000 -DBOOST -DBOOST_HIGH -DRPMRAMP -DCL_MODE -DAFM_CL_RAMP "-DAFM_CL_TARGET=8'h59" -DSKIP_LAMBDA_WARMUP -DSIM_TIME=30000000000 ;;
