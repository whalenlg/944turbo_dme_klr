...
compile_and_run_klr() {
    ...
    # Optional ROM file overrides — see run_dashboard_tests.sh for details.
...
run_test cl_ramp_to_2000_BOOST_HIGH \
...
# i8051_dashboard_tb.v for the full derivation and known ~10-15% error
# band.
...
if [ -n "$1" ]; then
    ...
    case "$1" in
        ...
        cl_ramp_to_2000_BOOST_HIGH) run_test cl_ramp_to_2000_BOOST_HIGH $IARG -DTEST_CL_RAMP_TO_2000 -DBOOST -DBOOST_HIGH -DRPMRAMP -DCL_MODE -DAFM_CL_RAMP "-DAFM_CL_TARGET=8'h53" -DSKIP_LAMBDA_WARMUP -DSIM_TIME=30000000000 ;;
