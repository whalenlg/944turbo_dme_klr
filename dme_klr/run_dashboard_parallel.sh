...
ALL_TESTS=(
    ramp_to_3000 ramp_to_6000 ramp_to_6000_knock knock_sensor_defect knock_sensor_short_to_ground ramp_to_3000_FQS0 ramp_to_3000_FQS1 ramp_to_3000_FQS2 ramp_to_3000_FQS3 ramp_to_3000_FQS4 ramp_to_3000_FQS5 ramp_to_3000_FQS6 ramp_to_3000_FQS7 ramp_to_6000_FQS0 ramp_to_6000_FQS1 ramp_to_6000_FQS2 ramp_to_6000_FQS3 ramp_to_6000_FQS4 ramp_to_6000_FQS5 ramp_to_6000_FQS6 ramp_to_6000_FQS7 ramp_to_6100 ramp_to_6200 ramp_to_6300 cl_warm_idle cl_tippy_in cl_ramp_to_3000 cl_ramp_to_3000_KLR_BATT_LOW cl_ramp_to_3000_KLR_TPS_SUPPLY_LOW cl_ramp_to_3000_KLR_KNOCK_BLOCKED cl_ramp_to_3000_KLR_ADC0_NOISE_HIGH cl_ramp_to_6000_KLR_ADC0_NOISE_HIGH cl_ramp_to_6000_KLR_ADC0_NOISE_LOW cl_ramp_to_3000_BOOST cl_ramp_to_4500 cl_ramp_to_5000_BOOST_LOW cl_condition_cycle cl_condition_cycle_idle cl_ramp_to_6000 cl_ramp_to_6000_BOOST cl_ramp_to_6000_BOOST_ZERO cl_ramp_to_6000_BOOST_LOW cl_ramp_to_6000_BOOST_HIGH
...
validate_one() {
    ...
    local result
    result=$(python3 "$VALIDATE" "$name" "$dashlog" "$DME_ROM_FILE" 2>&1)
    local rc=$?
