...
run_test cl_ramp_to_6000_FQS0 \
    -DTEST_CL_RAMP_TO_6000  -DCPU_DEBUG -DCPU_DEEP_DEBUG -DKLR_DEBUG  \
    -DRPMRAMP -DCL_MODE -DAFM_CL_RAMP -DAFM_CL_TARGET=8\'hD8 \
    "-D_FUEL_QUAL=8'h00" \
...
run_test cl_ramp_to_6000_FQS5  -DCPU_DEBUG -DCPU_DEEP_DEBUG -DKLR_DEBUG  \
    -DTEST_CL_RAMP_TO_6000 \
    -DRPMRAMP -DCL_MODE -DAFM_CL_RAMP -DAFM_CL_TARGET=8\'hD8 \
    "-D_FUEL_QUAL=8'h91" \
    -DCL_FUEL_ENERGY_PCT=3 \
...
run_test cl_ramp_to_3000_FQS0 -DCPU_DEBUG -DCPU_DEEP_DEBUG -DKLR_DEBUG  \
    -DTEST_CL_RAMP_TO_3000 -DCPU_DEBUG -DCPU_DEEP_DEBUG -DKLR_DEBUG \
    -DRPMRAMP -DCL_MODE -DAFM_CL_RAMP -DAFM_CL_TARGET=8\'hD8 \
    -DRPMEND=3000 \
    -DRPM_RAMP_PCT=20 \
    "-D_FUEL_QUAL=8'h00" \
...
if [ -n "$1" ]; then
    ...
    case "$1" in
        ...
        cl_ramp_to_6000_FQS0) run_test cl_ramp_to_6000_FQS0 $IARG -DTEST_CL_RAMP_TO_6000 -DRPMRAMP  -DCPU_DEBUG -DCPU_DEEP_DEBUG -DKLR_DEBUG -DCL_MODE -DAFM_CL_RAMP "-DAFM_CL_TARGET=8'hD8" "-D_FUEL_QUAL=8'h00" -DCL_FUEL_ENERGY_PCT=0 -DSKIP_LAMBDA_WARMUP -DSIM_TIME=40000000000 ;;
        ...
        cl_ramp_to_6000_FQS5) run_test cl_ramp_to_6000_FQS5 $IARG -DTEST_CL_RAMP_TO_6000 -DRPMRAMP -DCL_MODE -DCPU_DEBUG  -DKLR_DEBUG  -DCPU_DEEP_DEBUG -DAFM_CL_RAMP "-DAFM_CL_TARGET=8'hD8" "-D_FUEL_QUAL=8'h91" -DCL_FUEL_ENERGY_PCT=3 -DSKIP_LAMBDA_WARMUP -DSIM_TIME=40000000000 ;;
        ...
        cl_ramp_to_3000_FQS0) run_test cl_ramp_to_3000_FQS0 $IARG -DTEST_CL_RAMP_TO_3000 -DCPU_DEBUG -D CPU_DEEP_DEBUG -DKLR_DEBUG -DRPMRAMP -DCL_MODE -DAFM_CL_RAMP -DRPMEND=3000 "-D_FUEL_QUAL=8'h00" -DCL_FUEL_ENERGY_PCT=0 -DSKIP_LAMBDA_WARMUP -DSIM_TIME=40000000000 ;;
        cl_ramp_to_3000_FQS1) run_test cl_ramp_to_3000_FQS1 $IARG -DTEST_CL_RAMP_TO_3000 -DRPMRAMP -DCL_MODE  -DCPU_DEBUG -DCPU_DEEP_DEBUG  -DKLR_DEBUG  -DAFM_CL_RAMP -DRPMEND=3000 "-D_FUEL_QUAL=8'h3B" -DCL_FUEL_ENERGY_PCT=3 -DSKIP_LAMBDA_WARMUP -DSIM_TIME=40000000000 ;;
        ...
        cl_ramp_to_3000_FQS5) run_test cl_ramp_to_3000_FQS5 $IARG -DTEST_CL_RAMP_TO_3000 -DRPMRAMP -DCL_MODE  -DCPU_DEBUG -DCPU_DEEP_DEBUG   -DKLR_DEBUG  -DAFM_CL_RAMP -DRPMEND=3000 "-D_FUEL_QUAL=8'h91" -DCL_FUEL_ENERGY_PCT=3 -DSKIP_LAMBDA_WARMUP -DSIM_TIME=40000000000 ;;
