...
if [ -n "$1" ]; then
    ...
    case "$1" in
        ...
        cl_ramp_to_5000_BOOST_LOW) run_test cl_ramp_to_5000_BOOST_LOW $IARG -DTEST_CL_RAMP_TO_5000 -DKLR_DEBUG -DBOOST -DBOOST_LOW -DRPMRAMP -DCL_MODE -DAFM_CL_RAMP "-DAFM_CL_TARGET=8'hA6" -DSKIP_LAMBDA_WARMUP -DSIM_TIME=35000000000 ;;
        ...
        cl_ramp_to_6000_BOOST_HIGH) run_test cl_ramp_to_6000_BOOST_HIGH $IARG -DTEST_CL_RAMP_TO_6000 -DBOOST -DBOOST_HIGH -DRPMRAMP -DCL_MODE -DAFM_CL_RAMP "-DAFM_CL_TARGET=8'hD8" -DSKIP_LAMBDA_WARMUP -DSIM_TIME=20000000000 ;;
