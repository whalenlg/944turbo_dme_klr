...
if [ -n "$1" ]; then
    ...
    case "$1" in
        ...
        cl_ramp_to_6000_KLR_ADC0_NOISE_HIGH) run_test cl_ramp_to_6000_KLR_ADC0_NOISE_HIGH $IARG -DTEST_CL_RAMP_TO_6000 -DKLR_DEBUG -DBOOST -DKLR_ADC0_NOISE_HIGH -DRPMRAMP -DCL_MODE -DAFM_CL_RAMP "-DAFM_CL_TARGET=8'hD8" -DSKIP_LAMBDA_WARMUP -DSIM_TIME=40000000000 ;;
        cl_ramp_to_6000_KLR_ADC0_NOISE_LOW) run_test cl_ramp_to_6000_KLR_ADC0_NOISE_LOW $IARG -DTEST_CL_RAMP_TO_6000 -DKLR_DEBUG -DBOOST -DKLR_ADC0_NOISE_LOW -DRPMRAMP -DCL_MODE -DAFM_CL_RAMP "-DAFM_CL_TARGET=8'hD8" -DSKIP_LAMBDA_WARMUP -DSIM_TIME=40000000000 ;;
        ...
        cl_ramp_to_6000_BOOST_LOW) run_test cl_ramp_to_6000_BOOST_LOW $IARG -DTEST_CL_RAMP_TO_6000 -DKLR_DEBUG -DBOOST -DBOOST_LOW -DRPMRAMP -DCL_MODE -DAFM_CL_RAMP "-DAFM_CL_TARGET=8'hD8" -DAFM_CL_STEP_NS=28409091 -DSKIP_LAMBDA_WARMUP -DSIM_TIME=40000000000 ;;
