...
if [ -n "$1" ]; then
    ...
    case "$1" in
        ...
        cl_ramp_to_6000_BOOST_HIGH) run_test cl_ramp_to_6000_BOOST_HIGH $IARG -DTEST_CL_RAMP_TO_6000 -DKLR_DEBUG -DBOOST -DBOOST_HIGH -DRPMRAMP -DCL_MODE -DAFM_CL_RAMP "-DAFM_CL_TARGET=8'hD8" -DSKIP_LAMBDA_WARMUP -DSIM_TIME=40000000000 ;;
