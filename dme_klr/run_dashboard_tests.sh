...
compile_and_run_klr() {
    ...
    # Optional ROM file overrides — set as environment variables before
    # invoking this script to point any test at different DME/KLR firmware
    # images without editing individual test definitions, e.g.:
    #   KLR_ROM_FILE=89KLR_951.mem ./run_dashboard_tests.sh cl_ramp_to_6000
    # Both directory and filename can be overridden independently; whatever
    # isn't set falls back to each module's own default path (see
    # i8051_top.v / klr_top.v). Quoting matters here — Verilog string
    # macros need embedded double-quotes preserved through the shell.
    local -a rom_overrides=()
    [ -n "$DME_ROM_DIR"  ] && rom_overrides+=("-DDME_ROM_DIR=\"${DME_ROM_DIR}\"")
    ...
    # Record what was actually requested here too (this goes to the
    # runner's own stdout, i.e. the .runner.log) — the $display in
    # i8051_top.v/klr_top.v records what the compiled Verilog actually
...
run_test cl_ramp_to_6000_KLR_ADC0_NOISE_LOW -DKLR_DEBUG \
    -DTEST_CL_RAMP_TO_6000 \
    -DRPMRAMP -DCL_MODE -DBOOST -DKLR_ADC0_NOISE_LOW -DAFM_CL_RAMP -DAFM_CL_TARGET=8\'hD8 \
    -DSKIP_LAMBDA_WARMUP -DSIM_TIME=10000000000

run_test cl_ramp_to_3000_BOOST -DKLR_DEBUG \
    -DTEST_CL_RAMP_TO_3000 \
    -DRPMRAMP -DCL_MODE -DBOOST -DAFM_CL_RAMP -DAFM_CL_TARGET=8\'h72 \
    -DSKIP_LAMBDA_WARMUP -DSIM_TIME=30000000000

run_test cl_ramp_to_2000_BOOST_HIGH -DKLR_DEBUG \
    -DTEST_CL_RAMP_TO_2000 \
    -DRPMRAMP -DCL_MODE -DBOOST -DBOOST_HIGH -DAFM_CL_RAMP -DAFM_CL_TARGET=8\'h59 \
    -DSKIP_LAMBDA_WARMUP -DSIM_TIME=30000000000

# AFM_CL_TARGET=0x83 — ESTIMATED, not independently calibrated against real
# CL_TRAJ data. See the TEST_CL_RAMP_TO_4500 comment block in
# i8051_dashboard_tb.v for the full derivation and the known ~10-15% error
# band; var_interrupt_gen_cl.v's own header explicitly flags that a test
# between the 3000/6000 anchor points needs re-verification once real data
# exists. Check the actual settled RPM in the log.
run_test cl_ramp_to_4500 \
    -DTEST_CL_RAMP_TO_4500 \
    -DRPMRAMP -DCL_MODE -DBOOST -DAFM_CL_RAMP -DAFM_CL_TARGET=8\'h9A \
    -DSKIP_LAMBDA_WARMUP -DSIM_TIME=35000000000

run_test cl_ramp_to_5000_BOOST_LOW -DKLR_DEBUG \
...
run_test cl_ramp_to_6000_BOOST -DKLR_DEBUG \
    -DTEST_CL_RAMP_TO_6000 \
    -DRPMRAMP -DCL_MODE -DBOOST -DAFM_CL_RAMP -DAFM_CL_TARGET=8\'hD8 -DAFM_CL_STEP_NS=28409091 \
    -DSKIP_LAMBDA_WARMUP -DSIM_TIME=40000000000

run_test cl_ramp_to_6000_BOOST_ZERO -DKLR_DEBUG \
    -DTEST_CL_RAMP_TO_6000 \
    -DRPMRAMP -DCL_MODE -DBOOST -DBOOST_ZERO -DAFM_CL_RAMP -DAFM_CL_TARGET=8\'hD8 -DAFM_CL_STEP_NS=28409091 \
    -DSKIP_LAMBDA_WARMUP -DSIM_TIME=10000000000

run_test cl_ramp_to_6000_BOOST_LOW -DKLR_DEBUG \
    -DTEST_CL_RAMP_TO_6000 \
    -DRPMRAMP -DCL_MODE -DBOOST -DBOOST_LOW -DAFM_CL_RAMP -DAFM_CL_TARGET=8\'hD8 -DAFM_CL_STEP_NS=28409091 \
    -DSKIP_LAMBDA_WARMUP -DSIM_TIME=20000000000

run_test cl_ramp_to_6000_BOOST_HIGH -DKLR_DEBUG \
    -DTEST_CL_RAMP_TO_6000 \
    -DRPMRAMP -DCL_MODE -DBOOST -DBOOST_HIGH -DAFM_CL_RAMP -DAFM_CL_TARGET=8\'hD8 -DAFM_CL_STEP_NS=28409091 \
    -DSKIP_LAMBDA_WARMUP -DSIM_TIME=40000000000
...
run_test cl_ramp_to_redline \
    ...
    -DRPMRAMP -DCL_MODE -DBOOST -DAFM_CL_RAMP -DAFM_CL_TARGET=8\'hEB \
    -DSKIP_LAMBDA_WARMUP -DSIM_TIME=40000000000
...
run_test ramp_to_6000_knock \
    ...
    -DRPMRAMP -DRPMSTART=100 -DRPMEND=6000 -DRPM_RAMP_PCT=25 \
    -DSKIP_LAMBDA_WARMUP -DSIM_TIME=40000000000 \
    -DTEST_KNOCK_PULSE -DRPM_RAMP_DOWN -DKLR_DEBUG

run_test knock_sensor_defect \
    -DTEST_RAMP_TO_6000 \
    -DRPMRAMP -DRPMSTART=100 -DRPMEND=6000 -DRPM_RAMP_PCT=25 \
    -DSKIP_LAMBDA_WARMUP -DSIM_TIME=40000000000 \
    -DTEST_KNOCK_FAKE_BLOCKED -DKLR_DEBUG

run_test knock_sensor_short_to_ground \
    -DTEST_RAMP_TO_6000 \
    -DRPMRAMP -DRPMSTART=100 -DRPMEND=6000 -DRPM_RAMP_PCT=25 \
    -DSKIP_LAMBDA_WARMUP -DSIM_TIME=40000000000 \
    -DTEST_KNOCK_SHORT_TO_GROUND -DKLR_DEBUG
...
if [ -n "$1" ]; then
    ...
    case "$1" in
        ...
        cl_ramp_to_3000_KLR_TPS_SUPPLY_LOW) run_test cl_ramp_to_3000_KLR_TPS_SUPPLY_LOW $IARG -DTEST_CL_RAMP_TO_3000 -DKLR_DEBUG -DBOOST -DKLR_TPS_SUPPLY_LOW -DRPMRAMP -DCL_MODE -DAFM_CL_RAMP "-DAFM_CL_TARGET=8'h72" -DSKIP_LAMBDA_WARMUP -DSIM_TIME=15000000000 ;;
        cl_ramp_to_3000_KLR_KNOCK_BLOCKED) run_test cl_ramp_to_3000_KLR_KNOCK_BLOCKED $IARG -DTEST_CL_RAMP_TO_3000 -DKLR_DEBUG -DBOOST -DTEST_KNOCK_FAKE_BLOCKED -DRPMRAMP -DCL_MODE -DAFM_CL_RAMP "-DAFM_CL_TARGET=8'h72" -DSKIP_LAMBDA_WARMUP -DSIM_TIME=30000000000 ;;
        cl_ramp_to_3000_KLR_ADC0_NOISE_HIGH) run_test cl_ramp_to_3000_KLR_ADC0_NOISE_HIGH $IARG -DTEST_CL_RAMP_TO_3000 -DKLR_DEBUG -DBOOST -DKLR_ADC0_NOISE_HIGH -DRPMRAMP -DCL_MODE -DAFM_CL_RAMP "-DAFM_CL_TARGET=8'h72" -DSKIP_LAMBDA_WARMUP -DSIM_TIME=30000000000 ;;
        cl_ramp_to_6000_KLR_ADC0_NOISE_HIGH) run_test cl_ramp_to_6000_KLR_ADC0_NOISE_HIGH $IARG -DTEST_CL_RAMP_TO_6000 -DKLR_DEBUG -DBOOST -DKLR_ADC0_NOISE_HIGH -DRPMRAMP -DCL_MODE -DAFM_CL_RAMP "-DAFM_CL_TARGET=8'hD8" -DSKIP_LAMBDA_WARMUP -DSIM_TIME=10000000000 ;;
        cl_ramp_to_6000_KLR_ADC0_NOISE_LOW) run_test cl_ramp_to_6000_KLR_ADC0_NOISE_LOW $IARG -DTEST_CL_RAMP_TO_6000 -DKLR_DEBUG -DBOOST -DKLR_ADC0_NOISE_LOW -DRPMRAMP -DCL_MODE -DAFM_CL_RAMP "-DAFM_CL_TARGET=8'hD8" -DSKIP_LAMBDA_WARMUP -DSIM_TIME=10000000000 ;;
        cl_ramp_to_3000_BOOST) run_test cl_ramp_to_3000_BOOST $IARG -DTEST_CL_RAMP_TO_3000 -DKLR_DEBUG -DBOOST -DRPMRAMP -DCL_MODE -DAFM_CL_RAMP "-DAFM_CL_TARGET=8'h72" -DSKIP_LAMBDA_WARMUP -DSIM_TIME=30000000000 ;;
        cl_ramp_to_2000_BOOST_HIGH) run_test cl_ramp_to_2000_BOOST_HIGH $IARG -DTEST_CL_RAMP_TO_2000 -DKLR_DEBUG -DBOOST -DBOOST_HIGH -DRPMRAMP -DCL_MODE -DAFM_CL_RAMP "-DAFM_CL_TARGET=8'h59" -DSKIP_LAMBDA_WARMUP -DSIM_TIME=30000000000 ;;
        ...
        cl_ramp_to_5000_BOOST_LOW) run_test cl_ramp_to_5000_BOOST_LOW $IARG -DTEST_CL_RAMP_TO_5000 -DKLR_DEBUG -DBOOST -DBOOST_LOW -DRPMRAMP -DCL_MODE -DAFM_CL_RAMP "-DAFM_CL_TARGET=8'hA6" -DSKIP_LAMBDA_WARMUP -DSIM_TIME=10000000000 ;;
        ...
        cl_ramp_to_6000_BOOST) run_test cl_ramp_to_6000_BOOST $IARG -DTEST_CL_RAMP_TO_6000 -DKLR_DEBUG -DBOOST -DRPMRAMP -DCL_MODE -DAFM_CL_RAMP "-DAFM_CL_TARGET=8'hD8" -DAFM_CL_STEP_NS=28409091 -DSKIP_LAMBDA_WARMUP -DSIM_TIME=40000000000 ;;
        cl_ramp_to_6000_BOOST_ZERO) run_test cl_ramp_to_6000_BOOST_ZERO $IARG -DTEST_CL_RAMP_TO_6000 -DKLR_DEBUG -DBOOST -DBOOST_ZERO -DRPMRAMP -DCL_MODE -DAFM_CL_RAMP "-DAFM_CL_TARGET=8'hD8" -DAFM_CL_STEP_NS=28409091 -DSKIP_LAMBDA_WARMUP -DSIM_TIME=10000000000 ;;
        cl_ramp_to_6000_BOOST_LOW) run_test cl_ramp_to_6000_BOOST_LOW $IARG -DTEST_CL_RAMP_TO_6000 -DKLR_DEBUG -DBOOST -DBOOST_LOW -DRPMRAMP -DCL_MODE -DAFM_CL_RAMP "-DAFM_CL_TARGET=8'hD8" -DAFM_CL_STEP_NS=28409091 -DSKIP_LAMBDA_WARMUP -DSIM_TIME=20000000000 ;;
        cl_ramp_to_6000_BOOST_HIGH) run_test cl_ramp_to_6000_BOOST_HIGH $IARG -DTEST_CL_RAMP_TO_6000 -DKLR_DEBUG -DBOOST -DBOOST_HIGH -DRPMRAMP -DCL_MODE -DAFM_CL_RAMP "-DAFM_CL_TARGET=8'hD8" -DAFM_CL_STEP_NS=28409091 -DSKIP_LAMBDA_WARMUP -DSIM_TIME=40000000000 ;;
        ...
        cl_ramp_to_6000_FQS3) run_test cl_ramp_to_6000_FQS3 $IARG -DTEST_CL_RAMP_TO_6000 -DRPMRAMP -DCL_MODE -DBOOST -DAFM_CL_RAMP "-DAFM_CL_TARGET=8'hD8" "-D_FUEL_QUAL=8'h75" -DCL_FUEL_ENERGY_PCT=6 -DSKIP_LAMBDA_WARMUP -DSIM_TIME=40000000000 ;;
        cl_ramp_to_6000_FQS4) run_test cl_ramp_to_6000_FQS4 $IARG -DTEST_CL_RAMP_TO_6000 -DRPMRAMP -DCL_MODE -DBOOST -DAFM_CL_RAMP "-DAFM_CL_TARGET=8'hD8" "-D_FUEL_QUAL=8'h81" -DCL_FUEL_ENERGY_PCT=0 -DSKIP_LAMBDA_WARMUP -DSIM_TIME=40000000000 ;;
        cl_ramp_to_6000_FQS5) run_test cl_ramp_to_6000_FQS5 $IARG -DTEST_CL_RAMP_TO_6000 -DRPMRAMP -DCL_MODE -DBOOST -DAFM_CL_RAMP "-DAFM_CL_TARGET=8'hD8" "-D_FUEL_QUAL=8'h91" -DCL_FUEL_ENERGY_PCT=3 -DSKIP_LAMBDA_WARMUP -DSIM_TIME=40000000000 ;;
        cl_ramp_to_6000_FQS6) run_test cl_ramp_to_6000_FQS6 $IARG -DTEST_CL_RAMP_TO_6000 -DRPMRAMP -DCL_MODE -DBOOST -DAFM_CL_RAMP "-DAFM_CL_TARGET=8'hD8" "-D_FUEL_QUAL=8'h9C" -DCL_FUEL_ENERGY_PCT=-3 -DSKIP_LAMBDA_WARMUP -DSIM_TIME=40000000000 ;;
        cl_ramp_to_6000_FQS7) run_test cl_ramp_to_6000_FQS7 $IARG -DTEST_CL_RAMP_TO_6000 -DRPMRAMP -DCL_MODE -DBOOST -DAFM_CL_RAMP "-DAFM_CL_TARGET=8'hD8" "-D_FUEL_QUAL=8'hA7" -DCL_FUEL_ENERGY_PCT=6 -DSKIP_LAMBDA_WARMUP -DSIM_TIME=40000000000 ;;
        cl_ramp_to_3000_FQS0) run_test cl_ramp_to_3000_FQS0 $IARG -DTEST_CL_RAMP_TO_3000 -DRPMRAMP -DCL_MODE -DBOOST -DAFM_CL_RAMP -DRPMEND=3000 "-D_FUEL_QUAL=8'h00" -DCL_FUEL_ENERGY_PCT=0 -DSKIP_LAMBDA_WARMUP -DSIM_TIME=40000000000 ;;
        cl_ramp_to_3000_FQS1) run_test cl_ramp_to_3000_FQS1 $IARG -DTEST_CL_RAMP_TO_3000 -DRPMRAMP -DCL_MODE -DBOOST -DAFM_CL_RAMP -DRPMEND=3000 "-D_FUEL_QUAL=8'h3B" -DCL_FUEL_ENERGY_PCT=3 -DSKIP_LAMBDA_WARMUP -DSIM_TIME=40000000000 ;;
        cl_ramp_to_3000_FQS2) run_test cl_ramp_to_3000_FQS2 $IARG -DTEST_CL_RAMP_TO_3000 -DRPMRAMP -DCL_MODE -DBOOST -DAFM_CL_RAMP -DRPMEND=3000 "-D_FUEL_QUAL=8'h5A" -DCL_FUEL_ENERGY_PCT=-3 -DSKIP_LAMBDA_WARMUP -DSIM_TIME=40000000000 ;;
        cl_ramp_to_3000_FQS3) run_test cl_ramp_to_3000_FQS3 $IARG -DTEST_CL_RAMP_TO_3000 -DRPMRAMP -DCL_MODE -DBOOST -DAFM_CL_RAMP -DRPMEND=3000 "-D_FUEL_QUAL=8'h75" -DCL_FUEL_ENERGY_PCT=6 -DSKIP_LAMBDA_WARMUP -DSIM_TIME=40000000000 ;;
        cl_ramp_to_3000_FQS4) run_test cl_ramp_to_3000_FQS4 $IARG -DTEST_CL_RAMP_TO_3000 -DRPMRAMP -DCL_MODE -DBOOST -DAFM_CL_RAMP -DRPMEND=3000 "-D_FUEL_QUAL=8'h81" -DCL_FUEL_ENERGY_PCT=0 -DSKIP_LAMBDA_WARMUP -DSIM_TIME=40000000000 ;;
        cl_ramp_to_3000_FQS5) run_test cl_ramp_to_3000_FQS5 $IARG -DTEST_CL_RAMP_TO_3000 -DRPMRAMP -DCL_MODE -DBOOST -DAFM_CL_RAMP -DRPMEND=3000 "-D_FUEL_QUAL=8'h91" -DCL_FUEL_ENERGY_PCT=3 -DSKIP_LAMBDA_WARMUP -DSIM_TIME=40000000000 ;;
        cl_ramp_to_3000_FQS6) run_test cl_ramp_to_3000_FQS6 $IARG -DTEST_CL_RAMP_TO_3000 -DRPMRAMP -DCL_MODE -DBOOST -DAFM_CL_RAMP -DRPMEND=3000 "-D_FUEL_QUAL=8'h9C" -DCL_FUEL_ENERGY_PCT=-3 -DSKIP_LAMBDA_WARMUP -DSIM_TIME=40000000000 ;;
        ...
        ramp_to_6000_knock) run_test ramp_to_6000_knock $IARG -DTEST_RAMP_TO_6000 -DRPMRAMP -DRPMSTART=100 -DRPMEND=6000 -DRPM_RAMP_PCT=25 -DSKIP_LAMBDA_WARMUP -DSIM_TIME=40000000000 -DTEST_KNOCK_PULSE -DRPM_RAMP_DOWN -DKLR_DEBUG ;;
        knock_sensor_defect) run_test knock_sensor_defect $IARG -DTEST_RAMP_TO_6000 -DRPMRAMP -DRPMSTART=100 -DRPMEND=6000 -DRPM_RAMP_PCT=25 -DSKIP_LAMBDA_WARMUP -DSIM_TIME=40000000000 -DTEST_KNOCK_FAKE_BLOCKED -DKLR_DEBUG ;;
        knock_sensor_short_to_ground) run_test knock_sensor_short_to_ground $IARG -DTEST_RAMP_TO_6000 -DRPMRAMP -DRPMSTART=100 -DRPMEND=6000 -DRPM_RAMP_PCT=25 -DSKIP_LAMBDA_WARMUP -DSIM_TIME=40000000000 -DTEST_KNOCK_SHORT_TO_GROUND -DKLR_DEBUG ;;
        ...
        *)
            ...
            echo "               cl_ramp_to_5000_BOOST_LOW cl_ramp_to_6000_BOOST_ZERO cl_ramp_to_6000_BOOST_LOW cl_ramp_to_6000_BOOST_HIGH cl_ramp_to_2000_BOOST_HIGH"
