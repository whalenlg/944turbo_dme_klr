...
run_test cl_ramp_to_6000_BOOST_LOW -DKLR_DEBUG -DCPU_DEBUG -DCPU_DEEP_DEBUG \
    -DTEST_CL_RAMP_TO_6000 \
    -DRPMRAMP -DCL_MODE -DBOOST -DBOOST_LOW -DAFM_CL_RAMP -DAFM_CL_TARGET=8\'hD8 \
    -DSKIP_LAMBDA_WARMUP -DSIM_TIME=40000000000
...
run_test cl_ramp_to_6000_BOOST_150PCT -DKLR_DEBUG -DCPU_DEBUG -DCPU_DEEP_DEBUG \
    -DTEST_CL_RAMP_TO_6000 \
    -DRPMRAMP -DCL_MODE -DBOOST -DBOOST_150PCT -DAFM_CL_RAMP -DAFM_CL_TARGET=8\'hD8 \
    -DSKIP_LAMBDA_WARMUP -DSIM_TIME=40000000000
...
if [ -n "$1" ]; then
    ...
    case "$1" in
        ...
        cl_ramp_to_6000_BOOST) run_test cl_ramp_to_6000_BOOST $IARG -DTEST_CL_RAMP_TO_6000 -DKLR_DEBUG -DCPU_DEBUG -DCPU_DEEP_DEBUG -DBOOST -DRPMRAMP -DCL_MODE -DAFM_CL_RAMP "-DAFM_CL_TARGET=8'hD8" -DSKIP_LAMBDA_WARMUP -DSIM_TIME=40000000000 ;;
        cl_ramp_to_6000_BOOST_ZERO) run_test cl_ramp_to_6000_BOOST_ZERO $IARG -DTEST_CL_RAMP_TO_6000 -DKLR_DEBUG -DCPU_DEBUG -DCPU_DEEP_DEBUG -DBOOST -DBOOST_ZERO -DRPMRAMP -DCL_MODE -DAFM_CL_RAMP "-DAFM_CL_TARGET=8'hD8" -DSKIP_LAMBDA_WARMUP -DSIM_TIME=40000000000 ;;
        cl_ramp_to_6000_BOOST_LOW) run_test cl_ramp_to_6000_BOOST_LOW $IARG -DTEST_CL_RAMP_TO_6000 -DKLR_DEBUG -DCPU_DEBUG -DCPU_DEEP_DEBUG -DBOOST -DBOOST_LOW -DRPMRAMP -DCL_MODE -DAFM_CL_RAMP "-DAFM_CL_TARGET=8'hD8" -DSKIP_LAMBDA_WARMUP -DSIM_TIME=40000000000 ;;
        cl_ramp_to_6000_BOOST_HIGH) run_test cl_ramp_to_6000_BOOST_HIGH $IARG -DTEST_CL_RAMP_TO_6000 -DKLR_DEBUG -DCPU_DEBUG -DCPU_DEEP_DEBUG -DBOOST -DBOOST_HIGH -DRPMRAMP -DCL_MODE -DAFM_CL_RAMP "-DAFM_CL_TARGET=8'hD8" -DSKIP_LAMBDA_WARMUP -DSIM_TIME=40000000000 ;;
        cl_ramp_to_6000_BOOST_150PCT) run_test cl_ramp_to_6000_BOOST_150PCT $IARG -DTEST_CL_RAMP_TO_6000 -DKLR_DEBUG -DCPU_DEBUG -DCPU_DEEP_DEBUG -DBOOST -DBOOST_150PCT -DRPMRAMP -DCL_MODE -DAFM_CL_RAMP "-DAFM_CL_TARGET=8'hD8" -DSKIP_LAMBDA_WARMUP -DSIM_TIME=40000000000 ;;
