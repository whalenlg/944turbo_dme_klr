...
run_test cl_ramp_to_4500_BOOST_LOW -DKLR_DEBUG -DCPU_DEBUG -DCPU_DEEP_DEBUG \
    -DTEST_CL_RAMP_TO_4500 \
    -DRPMRAMP -DCL_MODE -DBOOST -DBOOST_LOW -DAFM_CL_RAMP -DAFM_CL_TARGET=8\'h9A \
    -DSKIP_LAMBDA_WARMUP -DSIM_TIME=70000000000
...
run_test cl_ramp_to_6000_BOOST_LOW -DKLR_DEBUG -DCPU_DEBUG -DCPU_DEEP_DEBUG \
    ...
    -DSKIP_LAMBDA_WARMUP -DSIM_TIME=80000000000
...
run_test cl_ramp_to_6000_FQS5 -DKLR_DEBUG -DCPU_DEBUG -DCPU_DEEP_DEBUG  \
    -DTEST_CL_RAMP_TO_6000 \
    -DRPMRAMP -DCL_MODE -DBOOST -DAFM_CL_RAMP -DAFM_CL_TARGET=8\'hD8 \
    "-D_FUEL_QUAL=8'h91" \
    -DCL_FUEL_ENERGY_PCT=3 \
...
if [ -n "$1" ]; then
    ...
    case "$1" in
        ...
        cl_ramp_to_4500_BOOST_LOW) run_test cl_ramp_to_4500_BOOST_LOW $IARG -DTEST_CL_RAMP_TO_4500 -DKLR_DEBUG -DCPU_DEBUG -DCPU_DEEP_DEBUG -DBOOST -DBOOST_LOW -DRPMRAMP -DCL_MODE -DAFM_CL_RAMP "-DAFM_CL_TARGET=8'h9A" -DSKIP_LAMBDA_WARMUP -DSIM_TIME=70000000000 ;;
        ...
        cl_ramp_to_6000_BOOST_LOW) run_test cl_ramp_to_6000_BOOST_LOW $IARG -DTEST_CL_RAMP_TO_6000 -DKLR_DEBUG -DCPU_DEBUG -DCPU_DEEP_DEBUG -DBOOST -DBOOST_LOW -DRPMRAMP -DCL_MODE -DAFM_CL_RAMP "-DAFM_CL_TARGET=8'hD8" -DAFM_CL_STEP_NS=28409091 -DSKIP_LAMBDA_WARMUP -DSIM_TIME=80000000000 ;;
        ...
        cl_ramp_to_6000_FQS5) run_test cl_ramp_to_6000_FQS5 $IARG -DTEST_CL_RAMP_TO_6000 -DKLR_DEBUG -DCPU_DEBUG -DCPU_DEEP_DEBUG  -DRPMRAMP -DCL_MODE -DBOOST -DAFM_CL_RAMP "-DAFM_CL_TARGET=8'hD8" "-D_FUEL_QUAL=8'h91" -DCL_FUEL_ENERGY_PCT=3 -DSKIP_LAMBDA_WARMUP -DSIM_TIME=40000000000 ;;
