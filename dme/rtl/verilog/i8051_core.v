// ============================================================
//  DME_DEBUG: define to enable verbose trace output.
...
//
//  Usage:
//    With tracing:   iverilog -DDME_DEBUG ...
...
`endif
            case (addr)
                ...
                8'hE0: acc     <= val;
                8'hF0: b_reg   <= val;
                default: begin `ifdef DME_DEEP_DEBUG $display("DME: [SFR_WRITE] *** undefined SFR addr=%02Xh ignored ***", addr); `endif end
            endcase
        end
    endtask
