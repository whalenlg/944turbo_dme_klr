...
// --- TEST_CL_RAMP_TO_2000 --- (ESTIMATED AFM target — see the
// i8051_dashboard_tb.v TEST_CL_RAMP_TO_2000 comment for how it was derived)
`ifdef TEST_CL_RAMP_TO_2000
  `define RPMRAMP
  `define SKIP_LAMBDA_WARMUP
  `define CL_MODE
  `define AFM_CL_RAMP
  `define AFM_CL_TARGET  8'h53      // ~2000 RPM (ESTIMATED)
  `undef  SIM_TIME
